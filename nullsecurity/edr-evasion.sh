...
clear
echo -e "${RED}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
echo -e "${WHITE}  NULLSEC EDR EVASION${RESET}"
echo -e "${RED}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
echo ""
...
if [[ "$DEMO" =~ ^[Yy]$ ]]; then
    ...
    echo -e "${GREEN}[+] Simulating EDR Evasion on $TARGET${RESET}"
    echo -e "${CYAN}[*] Attack vector identified${RESET}"
    echo -e "${GREEN}[+] Exploitation successful (simulated)${RESET}"
else
    echo -e "${YELLOW}[*] Configure attack parameters for EDR Evasion${RESET}"
    echo -e "${CYAN}[*] Module: edr-evasion${RESET}"
fi
