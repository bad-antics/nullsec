...
clear
echo -e "${RED}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
echo -e "${WHITE}  NULLSEC CSP BYPASS${RESET}"
echo -e "${RED}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
echo ""
...
if [[ "$DEMO" =~ ^[Yy]$ ]]; then
    ...
    echo -e "${GREEN}[+] Simulating CSP Bypass on $TARGET${RESET}"
    echo -e "${CYAN}[*] Attack vector identified${RESET}"
    echo -e "${GREEN}[+] Exploitation successful (simulated)${RESET}"
else
    echo -e "${YELLOW}[*] Configure attack parameters for CSP Bypass${RESET}"
    echo -e "${CYAN}[*] Module: csp-bypass${RESET}"
fi
