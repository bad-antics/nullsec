...
clear
echo -e "${RED}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
echo -e "${WHITE}  NULLSEC LDAP INJECTION${RESET}"
echo -e "${RED}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
echo ""
...
if [[ "$DEMO" =~ ^[Yy]$ ]]; then
    ...
    echo -e "${GREEN}[+] Simulating LDAP Injection on $TARGET${RESET}"
    echo -e "${CYAN}[*] Attack vector identified${RESET}"
    echo -e "${GREEN}[+] Exploitation successful (simulated)${RESET}"
else
    echo -e "${YELLOW}[*] Configure attack parameters for LDAP Injection${RESET}"
    echo -e "${CYAN}[*] Module: ldap-injection${RESET}"
fi
