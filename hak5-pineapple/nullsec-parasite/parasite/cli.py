...
@click.group()
def main():
    """🦠 nullsec-parasite — Dependency Infection Analyzer"""
    pass
...
def scan(filepath):
    ...
    click.echo(f"\n🦠 Scanning {filepath} for parasitic dependencies...\n")
...
def installed():
    ...
    click.echo("\n🦠 Scanning installed packages for parasites...\n")
