...
## **The Freakshow Suite — 20 Weird & Creepy Security Tools**

[![Python](https://img.shields.io/badge/python-3.8+-blue.svg)](https://python.org)
[![bad-antics](https://img.shields.io/badge/by-bad--antics-red.svg)](https://github.com/bad-antics)
[![Tools](https://img.shields.io/badge/tools-20-red.svg)](https://github.com/bad-antics)
...
| 3 | 📊 **Entropy** | `entropy` | Shannon entropy analyzer — detect stego, weak crypto, packed malware |
...
| 9 | 👻 **Phantom** | `phantom` | Ghost network packets — spectral traffic analysis |
...
| 12 | 🦠 **Parasite** | `parasite` | Dependency infection analyzer — supply chain parasite detection |
...
| 15 | 👻 **Poltergeist** | `poltergeist` | Filesystem chaos agent — anomaly detection & honeypots |
...
| 18 | 👻 **Banshee** | `banshee` | Log scream detector — the banshee hears all |
...
```bash
# Install the entire freakshow
pip install nullsec-freakshow

# Or install individually
pip install nullsec-sigil nullsec-whisper nullsec-grimoire ...
```

## 🖥️ Quick Demo

```bash
# Generate a haunted audio file with hidden message
whisper generate --message "HELP ME" --output ghost.wav

# Hunt processes pretending to be other processes
skinwalker scan
...
# Detect files with identity crises
doppelganger scan /Downloads

# Hunt resource-devouring processes
wendigo vitals
```
