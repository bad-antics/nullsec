...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Category-automation-blue">
</p>

## 📝 Description

Automated WiFi attack chain for quick exploitation

## ✨ Features

- Fully compatible with WiFi Pineapple Pager
- NullSec library integration
- Detailed logging to `/root/loot/autopwn/`
- Clean exit handling
...
mkdir -p /root/payloads/user/nullsec/AutoPwn
wget -O /root/payloads/user/nullsec/AutoPwn/payload.sh \
  https://raw.githubusercontent.com/bad-antics/nullsec-payload-autopwn/main/payload.sh
chmod +x /root/payloads/user/nullsec/AutoPwn/payload.sh
```
...
### From Pineapple UI
1. **Payloads** → **User** → **nullsec** → **AutoPwn**
2. Click **Run**

### As Targeted Payload
1. **Recon** → Start scan → Select target
2. **Payloads** → **NullSec-AutoPwn**
