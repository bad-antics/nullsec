...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Category-capture-blue">
</p>

## 📝 Description

Capture WPA/WPA2 handshakes for cracking

## ✨ Features

- Fully compatible with WiFi Pineapple Pager
- NullSec library integration
- Detailed logging to `/root/loot/handshakehunter/`
- Clean exit handling
...
mkdir -p /root/payloads/user/nullsec/HandshakeHunter
wget -O /root/payloads/user/nullsec/HandshakeHunter/payload.sh \
  https://raw.githubusercontent.com/bad-antics/nullsec-payload-handshakehunter/main/payload.sh
chmod +x /root/payloads/user/nullsec/HandshakeHunter/payload.sh
```
...
### From Pineapple UI
1. **Payloads** → **User** → **nullsec** → **HandshakeHunter**
2. Click **Run**

### As Targeted Payload
1. **Recon** → Start scan → Select target
2. **Payloads** → **NullSec-HandshakeHunter**
