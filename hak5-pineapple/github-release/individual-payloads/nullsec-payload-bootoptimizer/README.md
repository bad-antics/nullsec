...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Category-utility-blue">
</p>

## 📝 Description

Optimize Pineapple boot time and performance

## ✨ Features

- Fully compatible with WiFi Pineapple Pager
- NullSec library integration
- Detailed logging to `/root/loot/bootoptimizer/`
- Clean exit handling
...
mkdir -p /root/payloads/user/nullsec/BootOptimizer
wget -O /root/payloads/user/nullsec/BootOptimizer/payload.sh \
  https://raw.githubusercontent.com/bad-antics/nullsec-payload-bootoptimizer/main/payload.sh
chmod +x /root/payloads/user/nullsec/BootOptimizer/payload.sh
```
...
### From Pineapple UI
1. **Payloads** → **User** → **nullsec** → **BootOptimizer**
2. Click **Run**

### As Targeted Payload
1. **Recon** → Start scan → Select target
2. **Payloads** → **NullSec-BootOptimizer**
