...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Category-stealth-blue">
</p>

## 📝 Description

Deploy decoy AP to detect and log attackers

## ✨ Features

- Fully compatible with WiFi Pineapple Pager
- NullSec library integration
- Detailed logging to `/root/loot/honeypot/`
- Clean exit handling
...
mkdir -p /root/payloads/user/nullsec/Honeypot
wget -O /root/payloads/user/nullsec/Honeypot/payload.sh \
  https://raw.githubusercontent.com/bad-antics/nullsec-payload-honeypot/main/payload.sh
chmod +x /root/payloads/user/nullsec/Honeypot/payload.sh
```
...
### From Pineapple UI
1. **Payloads** → **User** → **nullsec** → **Honeypot**
2. Click **Run**

### As Targeted Payload
1. **Recon** → Start scan → Select target
2. **Payloads** → **NullSec-Honeypot**
