# NullSec Payload: WaveRider

<p align="center">
  <img src="https://img.shields.io/badge/NullSec-Pineapple%20Suite-00d4ff?style=for-the-badge" alt="NullSec">
  <img src="https://img.shields.io/badge/Category-Advanced-9b59b6?style=for-the-badge" alt="Category">
...
### One-Line Install
```bash
ssh root@172.16.52.1 'mkdir -p /root/payloads/user/nullsec/WaveRider && wget -qO /root/payloads/user/nullsec/WaveRider/payload.sh https://raw.githubusercontent.com/bad-antics/nullsec-pineapple-suite/main/payloads/advanced/WaveRider/payload.sh'
```
...
# Copy to device
scp nullsec-pineapple-suite/payloads/advanced/WaveRider/payload.sh \
    root@172.16.52.1:/root/payloads/user/nullsec/WaveRider/
```
...
### Standard Execution
```
Dashboard → Payloads → User → nullsec → WaveRider → Run
```

### Targeted Execution (from Recon)
```
Dashboard → Recon → [Select Target] → Payloads → NullSec-WaveRider
```
...
# Run directly
/root/payloads/user/nullsec/WaveRider/payload.sh [options]
```
...
```
/root/loot/WaveRider/
├── waverider_YYYYMMDD_HHMMSS.log    # Execution log
...
```bash
vim /root/payloads/user/nullsec/WaveRider/payload.sh
```
...
```
/root/payloads/recon/access_point/NullSec-WaveRider/payload.sh
/root/payloads/recon/client/NullSec-WaveRider/payload.sh
```
