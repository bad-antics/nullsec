# NullSec Payload: CoffeeShopAttack

<p align="center">
  <img src="https://img.shields.io/badge/NullSec-Pineapple%20Suite-00d4ff?style=for-the-badge" alt="NullSec">
  <img src="https://img.shields.io/badge/Category-Social-9b59b6?style=for-the-badge" alt="Category">
...
**Public WiFi credential harvesting**
...
### One-Line Install
```bash
ssh root@172.16.52.1 'mkdir -p /root/payloads/user/nullsec/CoffeeShopAttack && wget -qO /root/payloads/user/nullsec/CoffeeShopAttack/payload.sh https://raw.githubusercontent.com/bad-antics/nullsec-pineapple-suite/main/payloads/social/CoffeeShopAttack/payload.sh'
```
...
# Copy to device
scp nullsec-pineapple-suite/payloads/social/CoffeeShopAttack/payload.sh \
    root@172.16.52.1:/root/payloads/user/nullsec/CoffeeShopAttack/
```
...
### Standard Execution
```
Dashboard → Payloads → User → nullsec → CoffeeShopAttack → Run
```

### Targeted Execution (from Recon)
```
Dashboard → Recon → [Select Target] → Payloads → NullSec-CoffeeShopAttack
```
...
# Run directly
/root/payloads/user/nullsec/CoffeeShopAttack/payload.sh [options]
```

## 📁 Output Location

```
/root/loot/CoffeeShopAttack/
├── coffeeshopattack_YYYYMMDD_HHMMSS.log    # Execution log
...
```bash
vim /root/payloads/user/nullsec/CoffeeShopAttack/payload.sh
```
...
```
/root/payloads/recon/access_point/NullSec-CoffeeShopAttack/payload.sh
/root/payloads/recon/client/NullSec-CoffeeShopAttack/payload.sh
```
