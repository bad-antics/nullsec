...
**Capture and analyze probe requests**
...
Capture and analyze probe requests. This payload is part of the NullSec Pineapple Suite - the ultimate payload collection for WiFi Pineapple Pager.

## ✨ Features

- ✅ SSID history extraction
- ✅ Device profiling
...
```bash
# Download payload
wget https://raw.githubusercontent.com/bad-antics/nullsec-pineapple-suite/main/payloads/recon/ProbeHunter/payload.sh

# Upload to Pager
scp payload.sh root@172.16.42.1:/root/payloads/user/nullsec/ProbeHunter/
```
...
3. Choose **NullSec-ProbeHunter** from payload menu
...
├── probehunter_YYYYMMDD_HHMMSS.log
└── captures/
```

## 🔧 Configuration

Edit `/root/payloads/library/nullsec-lib.sh` for global settings, or modify the payload script directly for ProbeHunter-specific options.
