# NullSec Payload: WiFiConfuser

<p align="center">
  <img src="https://img.shields.io/badge/NullSec-Pineapple%20Suite-00d4ff?style=for-the-badge" alt="NullSec">
  <img src="https://img.shields.io/badge/Category-Pranks-9b59b6?style=for-the-badge" alt="Category">
...
### One-Line Install
```bash
ssh root@172.16.52.1 'mkdir -p /root/payloads/user/nullsec/WiFiConfuser && wget -qO /root/payloads/user/nullsec/WiFiConfuser/payload.sh https://raw.githubusercontent.com/bad-antics/nullsec-pineapple-suite/main/payloads/pranks/WiFiConfuser/payload.sh'
```
...
# Copy to device
scp nullsec-pineapple-suite/payloads/pranks/WiFiConfuser/payload.sh \
    root@172.16.52.1:/root/payloads/user/nullsec/WiFiConfuser/
```
...
### Standard Execution
```
Dashboard → Payloads → User → nullsec → WiFiConfuser → Run
```

### Targeted Execution (from Recon)
```
Dashboard → Recon → [Select Target] → Payloads → NullSec-WiFiConfuser
```
...
# Run directly
/root/payloads/user/nullsec/WiFiConfuser/payload.sh [options]
```

## 📁 Output Location

```
/root/loot/WiFiConfuser/
├── wificonfuser_YYYYMMDD_HHMMSS.log    # Execution log
...
```bash
vim /root/payloads/user/nullsec/WiFiConfuser/payload.sh
```
...
```
/root/payloads/recon/access_point/NullSec-WiFiConfuser/payload.sh
/root/payloads/recon/client/NullSec-WiFiConfuser/payload.sh
```
