...
Mass deauthentication flood attack. This payload is part of the NullSec Pineapple Suite - the ultimate payload collection for WiFi Pineapple Pager.

## ✨ Features

- ✅ Flood targets with deauth frames
- ✅ Multi-channel support
- ✅ Adjustable intensity
- ✅ Target all or specific clients
...
```bash
# Download payload
wget https://raw.githubusercontent.com/bad-antics/nullsec-pineapple-suite/main/payloads/attack/DeauthStorm/payload.sh

# Upload to Pager
scp payload.sh root@172.16.42.1:/root/payloads/user/nullsec/DeauthStorm/
```
...
3. Choose **NullSec-DeauthStorm** from payload menu
...
├── deauthstorm_YYYYMMDD_HHMMSS.log
└── captures/
```

## 🔧 Configuration

Edit `/root/payloads/library/nullsec-lib.sh` for global settings, or modify the payload script directly for DeauthStorm-specific options.
