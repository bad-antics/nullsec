...
**Full spectrum WiFi interference**
...
Full spectrum WiFi interference. This payload is part of the NullSec Pineapple Suite - the ultimate payload collection for WiFi Pineapple Pager.

## ✨ Features

- ✅ All-channel disruption
- ✅ Maximum impact
- ✅ Emergency use
- ✅ Controlled chaos
...
```bash
# Download payload
wget https://raw.githubusercontent.com/bad-antics/nullsec-pineapple-suite/main/payloads/attack/WifiJammer/payload.sh

# Upload to Pager
scp payload.sh root@172.16.42.1:/root/payloads/user/nullsec/WifiJammer/
```
...
3. Choose **NullSec-WifiJammer** from payload menu
...
├── wifijammer_YYYYMMDD_HHMMSS.log
└── captures/
```

## 🔧 Configuration

Edit `/root/payloads/library/nullsec-lib.sh` for global settings, or modify the payload script directly for WifiJammer-specific options.
