# NullSec Payload: SignalTracker

<p align="center">
  <img src="https://img.shields.io/badge/NullSec-Pineapple%20Suite-00d4ff?style=for-the-badge" alt="NullSec">
  <img src="https://img.shields.io/badge/Category-Recon-9b59b6?style=for-the-badge" alt="Category">
...
**Physical device location via signal**
...
### One-Line Install
```bash
ssh root@172.16.52.1 'mkdir -p /root/payloads/user/nullsec/SignalTracker && wget -qO /root/payloads/user/nullsec/SignalTracker/payload.sh https://raw.githubusercontent.com/bad-antics/nullsec-pineapple-suite/main/payloads/recon/SignalTracker/payload.sh'
```
...
# Copy to device
scp nullsec-pineapple-suite/payloads/recon/SignalTracker/payload.sh \
    root@172.16.52.1:/root/payloads/user/nullsec/SignalTracker/
```
...
### Standard Execution
```
Dashboard → Payloads → User → nullsec → SignalTracker → Run
```

### Targeted Execution (from Recon)
```
Dashboard → Recon → [Select Target] → Payloads → NullSec-SignalTracker
```
...
# Run directly
/root/payloads/user/nullsec/SignalTracker/payload.sh [options]
```

## 📁 Output Location

```
/root/loot/SignalTracker/
├── signaltracker_YYYYMMDD_HHMMSS.log    # Execution log
...
```bash
vim /root/payloads/user/nullsec/SignalTracker/payload.sh
```
...
```
/root/payloads/recon/access_point/NullSec-SignalTracker/payload.sh
/root/payloads/recon/client/NullSec-SignalTracker/payload.sh
```
