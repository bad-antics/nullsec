"""
Banshee Engine — Listens for screams in log files.
...
# The Banshee's ears — patterns that trigger screams
SCREAM_PATTERNS = {
    "PANIC": {
        "patterns": [
...
def wail_analysis(screams: List[Dict]) -> Dict:
    ...
    if analysis["critical_count"] > 10:
        analysis["verdict"] = "💀 THE BANSHEE WAILS! CRITICAL SYSTEM FAILURE DETECTED!"
        ...
        analysis["verdict"] = f"🔶 {analysis['high_count']} high-severity issues — the banshee stirs."
    elif len(screams) > 50:
